...
class Assignment(db.Model):
    ...
    def upsert(cls, assignment_new: 'Assignment'):
        assertions.assert_valid(assignment_new.content is not None, "Assignment content cannot be empty")
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        # Only principal can cross grade assignments
        if auth_principal.principal_id is None: 
            # If not principal then check if current teacher was the one to whom the assignment was submitted
            assertions.assert_valid(assignment.teacher_id == auth_principal.teacher_id, "Assignment can only be graded by the teacher to whom it was submitted")
